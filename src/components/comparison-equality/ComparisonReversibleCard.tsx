...
export interface ComparisonReversibleCardProps {
  id?: string;
  textEn: string;
  textEs: string;
  speechRate?: number;
...
export const ComparisonReversibleCard: React.FC<ComparisonReversibleCardProps> = ({
  id,
  textEn,
  textEs,
  speechRate = 1.0,
  ...
  return (
    <div className={`w-full perspective-1000 ${className}`}>
      ...
      >
        {/* FRONT: English (No gradients, pure solid clean background) */}
        <div
        ...
        >
          <div className="flex-1 pr-3 text-base sm:text-lg font-medium leading-relaxed">
        ...
        {/* BACK: Spanish Translation (No gradients, solid background) */}
        <div
        ...
        >
          <div className="flex-1 pr-3 text-base sm:text-lg font-medium leading-relaxed italic">
            {textEs}
          </div>
