...
import { ComparisonTestData } from '../../data/comparisonComparativesData';
...
export interface ComparativesTestActivityProps {
...
export const ComparativesTestActivity: React.FC<ComparativesTestActivityProps> = ({
  tests,
  accent = 'US',
  speechRate = 1.0,
  onSuccess,
  ...
  const handleSpeakStartCard = (e: React.MouseEvent) => {
    ...
    speakEnglish(
      'Final Test: Comparison of Adjectives: Comparatives. Five interactive questions to evaluate your understanding of comparative adjectives. Click Start Test to begin.',
      speechRate,
      accent as 'US' | 'UK',
      () => setIsSpeakingIntro(true),
      () => setIsSpeakingIntro(false)
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold tracking-tight mt-0.5">
                      Comparación de Adjetivos: Comparativos
                    </h3>
                  </div>
                </div>
    ...
    return (
      <div className="w-full max-w-xl mx-auto py-10 px-4 text-center flex flex-col items-center justify-center animate-in zoom-in-95 duration-300">
        ...
        <p className="text-base text-slate-600 dark:text-slate-300 mt-2 max-w-md">
          Has completado los 5 test de la Sección 5: Comparison of Adjectives: Comparatives.
        </p>
        ...
        <div className="lg:col-span-7 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2.5">
            <span className="text-xs font-mono font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
              Opciones del Test {currentTest.testNumber}
            </span>
          ...
          <div className="flex flex-col gap-3 pt-1">
            ...
            {isChecked && (
              ...
              >
                ...
                <p className="mt-1 text-xs opacity-90 italic">{currentTest.explanationEn}</p>
              </div>
            )}
          </div>
        </div>
