...
import { ComparisonActivityData } from '../../data/comparisonComparativesData';
...
export interface ComparativesDragDropActivityProps {
...
export const ComparativesDragDropActivity: React.FC<ComparativesDragDropActivityProps> = ({
  activity,
  accent = 'US',
  speechRate = 1.0,
  onComplete,
