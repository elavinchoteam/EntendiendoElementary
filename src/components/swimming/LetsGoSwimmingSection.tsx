...
import { SwimmingActivity1Explore } from './SwimmingActivity1Explore';
import { SwimmingActivity2Choice } from './SwimmingActivity2Choice';
import { SwimmingActivity3Choice } from './SwimmingActivity3Choice';
import { SwimmingActivity4Choice } from './SwimmingActivity4Choice';
import { SwimmingActivity5Speech } from './SwimmingActivity5Speech';
import { SwimmingActivity6Speech } from './SwimmingActivity6Speech';
import { SwimmingActivity7Interaction } from './SwimmingActivity7Interaction';

export interface LetsGoSwimmingSectionProps {
  accent?: 'US' | 'UK';
  speechRate?: number;
  onSuccess?: () => void;
}
...
export const LetsGoSwimmingSection: React.FC<LetsGoSwimmingSectionProps> = ({
  accent = 'US',
  speechRate = 1.0,
  onSuccess,
}) => {
  ...
  // Active activity: 0 to 6 (Actividad 1 to Actividad 6, and Actividad 7: Interacción)
  ...
  return (
    <div className="relative w-full flex flex-col items-center">
      ...
      <button
        id="swimming-floating-prev-activity-btn"
        type="button"
        onClick={handlePrev}
      ...
      <button
        id="swimming-floating-next-activity-btn"
        type="button"
        onClick={handleNext}
      ...
      <div className="w-full max-w-5xl px-2 sm:px-6 md:px-8 py-4 flex flex-col gap-6">
        ...
        >
          {/* Navigation Pills (Actividad 1 to Actividad 6 and Actividad 7: Interacción) */}
        ...
        {/* Dynamic Activity Component View */}
        <div className="w-full">
          {currentActivityIdx === 0 && (
            <SwimmingActivity1Explore
              accent={accent}
