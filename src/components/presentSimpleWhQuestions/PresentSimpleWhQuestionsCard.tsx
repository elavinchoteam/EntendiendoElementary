...
export interface PresentSimpleWhQuestionsCardProps {
  textEn: string;
  textEs: string;
...
export const PresentSimpleWhQuestionsCard: React.FC<PresentSimpleWhQuestionsCardProps> = ({
  textEn,
  textEs,
  highlightWords = [],
  speechRate = 1.0,
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {/* ONLY speaker icon button - strictly no text labels */}
        <button
          type="button"
